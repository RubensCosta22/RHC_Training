-- Avatar privado por perfil. Mantem valores atuais e nao altera historico.
...
begin
  ...
  if p_avatar_path is null or p_avatar_path not like v_expected_prefix || length(p_avatar_path) > 500 then
